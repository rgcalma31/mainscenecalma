...
public class FirstScene : SEScene
{
	...
	public void initialize(SEResourceCache rsc) {
		base.initialize(rsc);
			...
			rsc.prepare_image("chibi1", "chibi1", get_scene_width()*0.5,get_scene_height()*0.65);
			rsc.prepare_font("myfont", "arial  color=#000000", 80);
			
			home1 = add_sprite_for_image(SEImage.for_resource("back"));
		    sprite = add_sprite_for_image(SEImage.for_resource("chibi1"));
			text = add_sprite_for_text("NATSU", "myfont");
